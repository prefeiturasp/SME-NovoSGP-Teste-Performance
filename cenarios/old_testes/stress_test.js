...
export function handleSummary(data) {
    return { "report/stress_test.html": htmlReport(data) };
}
...
export default function () {
    ...
    check(apiResponseIniciarProva, {
        'Verifica se o Status é 200 ou 411 no endpoint api/v1/provas-tai/579/iniciar-prova': (res) => res.status === 200 || res.status === 411,
    });
