...
function flow() {
  ...
  // Login alternativo (para Diário e Calendário)
  ...
  // Diário de Bordo (com login alternativo e planejamento longo)
  ...
  // Conselho de Classe – Recomendações
  ...
  // Calendário – Frequências (com login alternativo)
...
// Gera planejamento com mais de 200 caracteres
